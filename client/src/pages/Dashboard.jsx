  ...
  return (
    <div>
      <div className="max-w-7xl mx-auto px-4 py-8">
        <p className="text-2xl font-medium mb-6 bg-linear-to-r from-slate-600 to-slate-700 bg-clip-padding text-transparent sm:hidden">
          Welcome, Ananya
        </p>
        ...
        <div className="flex gap-4">
          ...
          >
            <PlusIcon className="size-11 transition-all duration-300 p-2.5 bg-linear-to-r from-indigo-300 to-indigo-500 text-white rounded-bl-full" />
          ...
          >
            <UploadCloudIcon className="size-11 transition-all duration-300 p-2.5 bg-linear-to-r from-purple-300 to-purple-500 text-white rounded-bl-full" />
